  ...
  await t.test('3. Live Workspace Scanner & Synthesis Contract', () => {
    ...
    const catalog = [
      ...
      },
      {
        id: 'incubator-v5',
        name: 'Incubator v5',
        github_url: 'https://github.com/Wolf-of-Blog-Street/incubator-v5-public',
    ...
    const roster = [
      { id: 'agent-d-pm', name: 'AgentD SEO', icon: '🤖', color: 'emerald' },
    ...
    // Project 1: Checked out by AgentD
    ...
    assert.equal(seoProj.checkedOutBy[0].agentName, 'AgentD SEO');
