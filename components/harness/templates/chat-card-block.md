...
- **Message:** `node harness/components/chat/chat.mjs say @seat[/context|/handle] "text"`, `@handle`, or `#channel`. Every session hears `#fleet`: use it only for what every agent must know.
